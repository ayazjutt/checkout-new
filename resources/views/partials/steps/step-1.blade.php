<div id="step-1-wrapper">
    ...
    <div class="bg-white shadow-md mt-6 lg:p-6 p-4 rounded-xl">
        ...
        <div class="relative flex items-center justify-between mt-4">
            <div class="flex h-6 items-center">
                <input id="processingType{{ $processing_type->id }}" aria-describedby="comments-description"
                    ...
                    <label for="processingType{{ $processing_type->id }}" class="cursor-pointer font-semibold text-[#3F4254] text-base ml-3">
    ...
    <div class="bg-white shadow-md mt-6 lg:p-6 p-4 rounded-xl">
        <div class="flex items-center justify-between">
            <p class="font-sans text-lg font-medium text-[#3F4254]">
